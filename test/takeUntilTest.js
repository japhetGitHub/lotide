...
describe("#takeUntil", () => {
  it("should return the elements before that element which satisfies the callback function - all numbers until a negative number is seen", () => {
  ...
  it("should return the elements before that element which satisfies the callback function - all strings until ',' character is seen", () => {
